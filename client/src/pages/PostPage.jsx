    ...
    <>
      <main className="w-full  m-auto px-[12px] sm:px-[20px] pb-[1000px] ">
        <div className=" h-screen max-w-[1400px] flex flex-col items-center text-center m-auto pt-[100px] ">
          ...
          <h1 className=" text-[25px] md:text-[40px] mx-[30px] max-w-[600px] font-serif m-auto font-[600] ">{post.title}</h1>
          <NavLink to={`/search?category=${post.category}`}>
             <button className=" py-[4px] px-[38px] first-letter:uppercase bg-[gray] active:bg-[blue] text-[19px] text-white rounded-[12px] my-[12px] " > {post.category} </button>
          </NavLink>
